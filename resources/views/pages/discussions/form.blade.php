        ...
        <div class="container">
            <div class="mb-5">
                <div class="d-flex align-items-center">
                    <div class="d-flex">
                        <div class="fs-2 fw-bold me-2 mb-0">Ask Questions</div>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-12">
                                <form
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            class="form-select @error('category_slug')
                                            is-invalid
                                        @enderror"
...
@section('after-script')
    <script>
        $(document).ready(function() {
            $('#content').summernote({
                placeholder: 'The details of your problem | What did you try? | What did you expect?',
                tabSize: 2,
                height: 320,
                toolbar: [
                    ['style', ['style']],
